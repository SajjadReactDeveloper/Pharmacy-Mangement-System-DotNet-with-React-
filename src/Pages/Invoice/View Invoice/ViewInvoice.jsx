...
export default function ViewInvoice() {
  ...
  React.useEffect(() => {
    const getData = async () => {
      const res = await axios.get(`https://localhost:7107/SuperVillain/invoice`);
      setCars(res.data);
    };
    getData();
  }, []);
  ...
  const deleteComplaint = async (id) => {
    try {
      const res = await axios.delete(`https://localhost:7107/SuperVillain/deleteInvoice/${id}`);
                    ...
                    .map((user, index) => {
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">{user.medicine}</TableCell>
